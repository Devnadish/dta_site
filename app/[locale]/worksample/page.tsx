          ...
          >
            <CardHeader className="p-0">
              <div className="relative w-full h-64 overflow-hidden bg-gray-100">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent group-hover:from-black/60 group-hover:to-black/30 flex items-end justify-start p-4">
